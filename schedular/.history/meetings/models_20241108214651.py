...
class MeetingExtensionHistory(models.Model):
    """Tracks the history of meeting extensions for analysis"""
    meeting = models.ForeignKey(Meeting, on_delete=models.CASCADE, related_name='extensions')
    ...
    def __str__(self):
        return f"Extension for {self.meeting.title}"