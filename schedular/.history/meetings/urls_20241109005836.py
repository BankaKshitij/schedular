...
from .views import AvailabilityView, AvailabilityDetailView, ExtendMeetingView, MeetingTypeAdminAPIView, ScheduleMeetingView, UserDayMeetingsView
...
urlpatterns = [
    ...
    path('user/<int:user_id>/day/<str:date_str>/', UserDayMeetingsView.as_view(), name='user_day_meetings'),
