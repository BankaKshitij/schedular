...
class AvailabilityView(APIView):
    ...
    #We would have to update this API as there would be meeting slots also coming in and we have to give availability accordingly
    def get(self, request):
        ...
        for availability in availabilities:
            start_time_local = availability.start_time.astimezone(tz)
            end_time_local = availability.end_time.astimezone(tz)
