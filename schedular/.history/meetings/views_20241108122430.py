                    ...
                    if slots:
                        for slot in slots:
                            try:
                                ...
                                # Localize times to user timezone and then convert to UTC
                                start_time_local = user_timezone.localize(start_time_naive)
                                end_time_local = user_timezone.localize(end_time_naive)
