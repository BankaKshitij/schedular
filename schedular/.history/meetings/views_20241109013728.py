...
class RescheduleSuggestionView(APIView):
    ...
    def post(self, request):
        ...
        if not meeting_id:
            return Response({"detail": "Meeting ID must be provided."}, status=status.HTTP_400_BAD_REQUEST)
...
"""
    ...
    def get_gpt_suggestions(self, prompt):
        ...
        headers = {
            "Authorization": f"Bearer sk-Ds9zatO9vLH7t335tYg3fef9pwMLROOLrajijGYTWrT3BlbkFJ-4-C8EyJzdoOIZHS3Xy6WOMTTDNkbW71oukGQYdLoA",
        ...
        if response.status_code == 200:
            ...
            suggestions_text = gpt_response.get("choices")[0].get("message").get("content")
