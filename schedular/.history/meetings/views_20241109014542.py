...
"""
        ...
        for username, data in all_availability.items():
            ...
            prompt += "Blocked Slots (existing meetings):\n"
            for slot in data['blocked_slots']:
                prompt += f"    From: {slot['start_time']} to {slot['end_time']}\n"
...
"""
    ...
    def get_gpt_suggestions(self, prompt):
        # Use OpenAI Python client instead of requests
        ...
        try:
            ...
            print(f"An error occurred while making the GPT API request: {str(e)}")
            return None
