...
"""
    ...
    def get_gpt_suggestions(self, prompt):
        client = OpenAI(api_key='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')
